    ...
    datasets: [
      {
        data: [540, 325, 702],
        backgroundColor: [
          documentStyle.value.getPropertyValue("--indigo-500"),
          documentStyle.value.getPropertyValue("--purple-500"),
          documentStyle.value.getPropertyValue("--teal-500"),
        ],
        hoverBackgroundColor: [
          documentStyle.value.getPropertyValue("--indigo-400"),
          documentStyle.value.getPropertyValue("--purple-400"),
          documentStyle.value.getPropertyValue("--teal-400"),
        ],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        backgroundColor: [
          ...
          documentStyle.value.getPropertyValue("--purple-500"),
          documentStyle.value.getPropertyValue("--teal-500"),
          documentStyle.value.getPropertyValue("--orange-500"),
        ],
        label: "My dataset",
      },
    ],
