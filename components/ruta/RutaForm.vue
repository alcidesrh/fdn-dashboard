<template>
  <form class="py-4" @submit.prevent="emitSubmit">
    <div class="mb-2">
      ...
      <input
        id="ruta_estacionOrigen"
        v-model="item.estacionOrigen"
        :class="[
          'mt-1 w-full px-3 py-2 border rounded',
          violations?.estacionOrigen ? 'border-red-500' : 'border-gray-300',
        ]"
        type="text"
        placeholder=""
      />
    ...
    <div class="mb-2">
      ...
      <input
        id="ruta_estacionDestino"
        v-model="item.estacionDestino"
        :class="[
          'mt-1 w-full px-3 py-2 border rounded',
          violations?.estacionDestino ? 'border-red-500' : 'border-gray-300',
        ]"
        type="text"
        placeholder=""
      />
